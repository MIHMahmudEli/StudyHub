    ...
    <main class="main-content flex-grow-1">
        ...
        <header class="topbar d-flex justify-content-between align-items-center mb-4">
            <div class="d-flex align-items-center gap-3">
                ...
                <h5 class="mb-0 fw-semibold">Pending Notes Review</h5>
            </div>
            <div class="d-flex align-items-center gap-3">
                            ...
                            <?php foreach ($notes as $row): ?>
                                <tr>
                                    <td>
                                        ...
                                        <small class="text-muted"><?php echo htmlspecialchars($row['course_code']); ?></small>
                                    </td>
                                    ...
                                    <td>
                                        ...
                                        ?>
                                        <a href="<?php echo url('preview/note'); ?>?id=<?php echo $row['id']; ?>&track=admin" target="_blank" class="text-decoration-none">
                                            <i class="fa <?php echo $icon; ?> fa-lg"></i> Preview
                                        </a>
                                    </td>
                                    <td>
                                        <div class="btn-group">
