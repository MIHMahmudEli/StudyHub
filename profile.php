...
<head>
    ...
    <!-- Custom CSS -->
    <link rel="stylesheet" href="assets/css/admin_dashboard.css?v=3.0.2">
...
<body>
    ...
    <aside class="sidebar">
        ...
        <ul class="nav flex-column">
            ...
            <li class="active" ><a href="profile.php" class="nav-link"><i class="fa fa-user me-2"></i>Profile</a></li>
        </ul>
    ...
    <script src="assets/js/admin_dashboard.js?v=3.0.2"></script>
</body>
</html>
